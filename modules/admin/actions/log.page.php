...
<page>
	...
	<title>[`|pc][`|pc]websiteName[`|pc][`|pc] - logs (admin)</title>
	<content>
		[[:theme::navtitlebox::label=Log: %%logFile%%::width=570:]]
		[`|lt]h1[`|gt]Access Logs[`|lt]/h1[`|gt]
		[[:admin::analog::type=pageview.log.php::log=%%logFile%%:]]
	</content>
