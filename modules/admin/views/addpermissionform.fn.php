...
//--------------------------------------------------------------------------------------------------
//|	form to add a permission to a a model definition in a module.xml.php file
//--------------------------------------------------------------------------------------------------
//arg: modulename - name of a kapenta module [string]
//arg: modelname - name of a model defined on this module [string]

function admin_addpermissionform($args) {
	global $user;
	global $theme;
	...
	//	make the block
	//----------------------------------------------------------------------------------------------
	$block = $theme->loadBlock('modules/admin/views/addpermissionform.block.php');
