...
//--------------------------------------------------------------------------------------------------
//*	Associates users with their badges.
//--------------------------------------------------------------------------------------------------

class Badges_UserIndex {
	...
	function toXml($xmlDec = false, $indent = '') {
		...
		$xml = $indent . "<kobject type='Badges_UserIndex'>\n"
			. $indent . "    <UID>" . $this->UID . "</UID>\n"
			. $indent . "    <userUID>" . $this->userUID . "</userUID>\n"
			. $indent . "    <badgeUID>" . $this->badgeUID . "</badgeUID>\n"
