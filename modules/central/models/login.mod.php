...
//--------------------------------------------------------------------------------------------------
//*	Records user logins on peer servers
//--------------------------------------------------------------------------------------------------
...
class Central_Login {
	...
	var $lastAssert;		//_ datetime [string]
	...
	function loadArray($ary) {
		...
		$this->lastAssert = $ary['lastAssert'];
	...
	function getDbSchema() {
		$dbSchema = array();
		$dbSchema['module'] = 'central';
		$dbSchema['model'] = 'Central_Login';
	...
	function toXml($xmlDec = false, $indent = '') {
		...
		$xml = $indent . "<kobject type='Central_Login'>\n"
			. $indent . "    <UID>" . $this->UID . "</UID>\n"
			. $indent . "    <userUID>" . $this->userUID . "</userUID>\n"
			. $indent . "    <peerURL>" . $this->peerURL . "</peerURL>\n"
			. $indent . "    <lastAssert>" . $this->lastAssert . "</lastAssert>\n"
	...
	function extArray() {
		...
		//	links
		//------------------------------------------------------------------------------------------
		if (true == $user->authHas('central', 'Central_Login', 'show', $this->UID)) {
			$ext['viewUrl'] = '%%serverPath%%Central/showlogin/' . $ext['UID'];
			$ext['viewLink'] = "<a href='" . $ext['viewUrl'] . "'>[ more &gt;gt; ]</a>";
		}

		if (true == $user->authHas('central', 'Central_Login', 'edit', 'edit', $this->UID)) {
			$ext['editUrl'] = '%%serverPath%%Central/editlogin/' . $ext['UID'];
			$ext['editLink'] = "<a href='" . $ext['editUrl'] . "'>[ edit ]</a>";
		}

		if (true == $user->authHas('central', 'Central_Login', 'edit', 'delete', $this->UID)) {
			$ext['delUrl'] = '%%serverPath%%Central/dellogin/' . $ext['UID'];
