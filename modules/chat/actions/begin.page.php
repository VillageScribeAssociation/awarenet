...
<page>
	...
	<title>:: [`|pc][`|pc]websiteName[`|pc][`|pc] :: chat :: all contacts ::</title>
	<content>[[:theme::navtitlebox::width=570::label=Chat:]]
[`|lt]h1[`|gt]All Users[`|lt]/h1[`|gt]
[[:chat::listallbegin:]]</content>
	<nav1></nav1>
	<nav2></nav2>
	<script></script>
	<jsinit></jsinit>
