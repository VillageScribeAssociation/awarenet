...
class Chat_Membership {
	...
	var $user;			//_ uid [string]
	var $room;			//_ uid [string]
	var $role;			//_ (member|admin) [string]
	var $state;			//_	(local|global) [string]
	var $createdOn;		//_ datetime [string]
	var $createdBy;		//_ ref:users_user [string]
	var $editedOn;		//_ datetime [string]
	var $editedBy;		//_ ref:users_user [string]
	var $shared;		//_ share with other instances over p2p module (yes|no) [string]
	...
	function getDbSchema() {
		...
		$dbSchema['model'] = 'chat_membership';
	...
	function extArray() {
		...
		//	links
		//------------------------------------------------------------------------------------------
		if (true == $user->authHas('chat', 'chat_membership', 'show', $ext['UID'])) {
			$ext['viewUrl'] = '%%serverPath%%chat/showmembership/' . $ext['UID'];
			$ext['viewLink'] = "<a href='" . $ext['viewUrl'] . "'>[ more &gt;gt; ]</a>";
		}

		if (true == $user->authHas('chat', 'chat_membership', 'edit', $ext['UID'])) {
			$ext['editUrl'] = '%%serverPath%%chat/editmembership/' . $ext['UID'];
			$ext['editLink'] = "<a href='" . $ext['editUrl'] . "'>[ edit ]</a>";
		}

		if (true == $user->authHas('chat', 'chat_membership', 'delete', $ext['UID'])) {
			$ext['delUrl'] = '%%serverPath%%chat/delmembership/' . $ext['UID'];
