...
class Chatserver_Session {
	...
	function Chatserver_Session($UID = '') {
		global $db;
	...
	function getDbSchema() {
		...
		$dbSchema['model'] = 'chatserver_session';
	...
	function extArray() {
		...
		//	links
		//------------------------------------------------------------------------------------------
		if (true == $user->authHas('chatserver', 'chatserver_session', 'show', $ext['UID'])) {
			$ext['viewUrl'] = '%%serverPath%%chatserver/showsession/' . $ext['UID'];
			$ext['viewLink'] = "<a href='" . $ext['viewUrl'] . "'>[ more &gt;&gt; ]</a>";
		}

		if (true == $user->authHas('chatserver', 'chatserver_session', 'edit', $ext['UID'])) {
			$ext['editUrl'] = '%%serverPath%%chatserver/editsession/' . $ext['UID'];
			$ext['editLink'] = "<a href='" . $ext['editUrl'] . "'>[ edit ]</a>";
		}

		if (true == $user->authHas('chatserver', 'chatserver_session', 'delete', $ext['UID'])) {
			$ext['delUrl'] = '%%serverPath%%chatserver/delsession/' . $ext['UID'];
