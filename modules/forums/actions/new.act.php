...
//--------------------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------------
	if (false == $kapenta->user->authHas('forums', 'forums_board', 'new')) { $kapenta->page->do403(); }
	//if ('admin' != $kapenta->user->role) { $kapenta->page->do403('Only administrators can create new boards.'); }
	...
	$model->school = $kapenta->user->school;
	$model->save();
