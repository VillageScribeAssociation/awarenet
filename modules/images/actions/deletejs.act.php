...
//--------------------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------------
	if (false == array_key_exists('UID', $_POST)) { $page->doXmlError('Image not specified.'); }

	$model = new Images_Image($_POST['UID']);
	if (false == $model->loaded) { $page->doXmlError('Image not found.'); }
	...
	if (false == $auth) { $page->doXmlError('You cannot delete this image.'); }
