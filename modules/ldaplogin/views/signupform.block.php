<? /*
<form name='signup' method='POST' action='%%serverPath%%ldaplogin/signup/'>
<input type='hidden' name='action' value='userSignup' />
<div class='block'>

<input type='hidden' id='pwd' name='password' value='%%password%%'  style='width: 100%' />
...
<table noborder width='100%'>
  ...
  <tr>
    <td><b>User Name:</b></td>
    <td><input type='text' id='uname' name='username' value='%%username%%' style='width: 100%' readonly/></td>
  </tr>
  <tr>
    <td><b>School:</b></td>
    <td><input type='text' name='school' value='%%school%%' style='width: 100%' readonly/></td>
  </tr>
  <tr>
    <td><b>Grade:</b></td>
    <td>
