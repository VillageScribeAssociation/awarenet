...
//--------------------------------------------------------------------------------------------------
//*	experimental PDF reader script
//--------------------------------------------------------------------------------------------------
//reqarg: course - UID of a Lessons_Course object [string]
//reqarg: document - UID of a PDF document within the referenced course [string]
...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
	...
	<script>
		var awarenetPDF = "%%pdfUrl%%";
	</script>

    <link rel="stylesheet" href="%%serverPath%%modules/lessons/css/viewer.css"/>

    <script type="text/javascript" src="%%serverPath%%modules/lessons/js/compatibility.js"></script>

	<!-- This snippet is used in production, see Makefile -->
	<link rel="resource" type="application/l10n" href="locale/locale.properties"/>
	<script type="text/javascript" src="%%serverPath%%modules/lessons/js/l10n.js"></script>
	<script type="text/javascript" src="%%serverPath%%modules/lessons/js/pdf.js"></script>

    <!-- <script type="text/javascript" src="debugger.js"></script> -->
    <script type="text/javascript" src="%%serverPath%%modules/lessons/js/viewer.js"></script>
  </head>
...
';
	...
	$html = str_replace('%%pdfUrl%%', $pdf, $html);
