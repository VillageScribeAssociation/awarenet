...
<page>
	...
	<content>
		...
		[[:theme::navtitlebox::label=Video Lessons (mobile):]]
		...
		<script language='Javascript'>
			function lessons_center() {
				var cmLeft = ($(window).width() - 320) / 2;
				$('#playerHover').css('left', cmLeft + 'px');
			}
			lessons_center();
		</script>
	
		<div id='divCMBacking' style='height: 220px;'>
		</div>

		[[:lessons::videossamecourse::UID=%%courseUID%%:]]

		<div class='block'>
		<a href='%%serverPath%%%%fileName%%'>Download this video</a> to your computer of mobile device.
		</div>
		...
		<div id='divAttrib'>
			...
			<small>
				...
				<a href='%%licenceurl%%'>%%licence%%</a> licence.
			</small>
		</div>
		-->
