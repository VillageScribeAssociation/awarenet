...
//--------------------------------------------------------------------------------------------------
//*	Records user endorsement.
//--------------------------------------------------------------------------------------------------

class Like_Something {
	...
	var $emotion;			//_ varchar(10) [string]
	var $cancelled;			//_ varchar(10) [string]
	...
	//.	constructor
	//----------------------------------------------------------------------------------------------
	//opt: UID - UID of a Something object [string]

	function Like_Something($UID = '') {
		global $db;
	...
	//----------------------------------------------------------------------------------------------
	//arg: UID - UID of a Something object [string]
	...
	//----------------------------------------------------------------------------------------------
	//.	load Something object serialized as an associative array
	//----------------------------------------------------------------------------------------------
	...
	function loadArray($ary) {
		...
		$this->emotion = $ary['emotion'];
		$this->cancelled = $ary['cancelled'];
	...
	function getDbSchema() {
		$dbSchema = array();
		$dbSchema['module'] = 'like';
		$dbSchema['model'] = 'like_something';
