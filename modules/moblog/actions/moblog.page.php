...
[[:theme::navtitlebox::label=Activity::toggle=divActivity:]]
[`|lt]div id=[`|sq]divActivity[`|sq] class='block'[`|gt]
[[:calendar::notificationmonthsubnav::year=current::month=current:]]
[`|lt]/div[`|gt]
[`|lt]div class='foot'[`|gt][`|lt]/div[`|gt]
[`|lt]br/[`|gt]
	...
	<banner></banner>
	<head>
	[`|lt]link rel="alternate" type="application/rss+xml" title="RSS (all blogs)" href="%%serverPath%%moblog/rss/" /[`|gt]
	</head>
