...
//--------------------------------------------------------------------------------------------------
	...
	if (false == $user->authHas('newsletter', 'Newsletter_Subscription', 'edit', $model->UID))
	...
	//----------------------------------------------------------------------------------------------
	if ('' == $report) { $session->msg('Saved changes to Subscription', 'ok'); }
	else { $session->msg('Could not save Subscription:<br/>' . $report, 'bad'); }
