...
//--------------------------------------------------------------------------------------------------
//*	Records objects deleted from database so that they are not re-downloaded.
//--------------------------------------------------------------------------------------------------
...
class P2P_Deleted {
	...
	var $shared;			//_ share with other peers? (yes|no) varchar(10) [string]
