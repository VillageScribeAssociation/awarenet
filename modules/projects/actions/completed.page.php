...
<page>
	...
	<content>[[:theme::navtitlebox::width=570::label=Completed Projects:]]
[[:live::river::rivermodule=projects::riverview=summarylist::riverpagevar=page::allow=num|pagination|status::num=7::status=closed::pagination=no:]]
</content>
	<nav1>
